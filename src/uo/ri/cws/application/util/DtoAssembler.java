...
public class DtoAssembler {
    ...
    public static List<PaymentMeanDto>
	    toPaymentMeanDtoList(List<PaymentMean> list) {
	return list.stream().map(mp -> toDto(mp))
	...
	dto.invoiceId =
		a.getInvoice() == null ? null : a.getInvoice().getId();
    ...
    public static List<WorkOrderDto>
	    toWorkOrderDtoList(List<WorkOrder> list) {
	return list.stream().map(a -> toDto(a)).collect(Collectors.toList());
    }

    public static List<CertificateDto>
	    toCertificateDtoList(List<Certificate> list) {
	return list.stream().map(a -> toDto(a)).collect(Collectors.toList());
    }
	...
	for (Dedication d : c.getDedications()) {
	    dto.percentages.put(d.getVehicleType().getId(),
		    d.getPercentage());
	}
    ...
    public static List<CourseDto> toCourseDtoList(List<Course> list) {
	return list.stream().map(a -> toDto(a)).collect(Collectors.toList());
    }

    public static List<VehicleTypeDto>
	    toVehicleTypeDtoList(List<VehicleType> list) {
	return list.stream().map(a -> toDto(a)).collect(Collectors.toList());
    }

    public static List<EnrollmentDto>
	    toEnrollmentDtoList(List<Enrollment> list) {
	return list.stream().map(a -> toDto(a)).collect(Collectors.toList());
    }
